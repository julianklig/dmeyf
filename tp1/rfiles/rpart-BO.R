...
eliminarColumnasDataDrift <- function( dataset )
{
    dataset[, "internet":=NULL]
    dataset[, "tpaquete1":=NULL]
    dataset[, "mcajeros_propios_descuentos":=NULL]
    dataset[, "mtarjeta_visa_descuentos":=NULL]
    dataset[, "mtarjeta_master_descuentos":=NULL]
...
dataset <- eliminarColumnasDataDrift(dataset)
dapply <- eliminarColumnasDataDrift(dapply)
