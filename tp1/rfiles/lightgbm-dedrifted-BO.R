...
switch ( Sys.info()[['sysname']],
         ...
         Linux   = { directory.root  <-  "~" } #Google Cloud
       )
...
kscript           <- "682_dedrifted_lgb_prob_auto"
karch_generacion  <- "./datasets/paquete_premium_202009_dedrifted.csv"
karch_aplicacion  <- "./datasets/paquete_premium_202011_dedrifted.csv"
...
ksemilla_azar  <- 216091  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
