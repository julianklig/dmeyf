...
kscript         <- "984_covid_fe3_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v097.csv.gz"  #el dataset que voy a utilizar
...
# ganancia 6285000  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 18 de un total de 100 inteligentes
param_ganadores  <- list( "learning_rate"= 0.09316186,
                          "feature_fraction"= 0.08705385,
                          "min_data_in_leaf"= 7635,
                          "num_leaves"= 311,
                          "num_iterations"= 292,
                          "lambda_l1"= 23.53431,
                          "lambda_l2"= 13.86876,
                          "ratio_corte"= 0.04931251
                        )
