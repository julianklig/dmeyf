...
kscript         <- "984_covid_tendencia1_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v095.csv.gz"  #el dataset que voy a utilizar
...
# ganancia 7046250  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 18 de un total de 100 inteligentes
param_ganadores  <- list( "learning_rate"= 0.08849183,
                          "feature_fraction"= 0.6073586,
                          "min_data_in_leaf"= 255,
                          "num_leaves"= 214,
                          "num_iterations"= 224,
                          "lambda_l1"= 11.89272,
                          "lambda_l2"= 86.83176,
                          "ratio_corte"= 0.03685153
                        )
