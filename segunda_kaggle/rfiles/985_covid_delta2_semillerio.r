...
kscript         <- "985_covid_delta2_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v091.csv.gz"  #el dataset que voy a utilizar
...
# ganancia  356070248  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 18 de un total de 100 inteligentes
param_ganadores  <- list( "learning_rate"= 0.03985954,
                          "feature_fraction"= 0.5334231,
                          "min_data_in_leaf"= 11,
                          "num_leaves"= 982,
                          "num_iterations"= 573,
                          "lambda_l1"= 0.07150382,
                          "lambda_l2"= 9.5891,
                          "ratio_corte"= 0.02847841
                        )
