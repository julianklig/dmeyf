...
kscript         <- "984_covid_delta3_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v093.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.01038296,
                          "feature_fraction"= 0.4817852,
                          "min_data_in_leaf"= 13,
                          "num_leaves"= 548,
                          "num_iterations"= 1603,
                          "lambda_l1"= 7.087506,
                          "lambda_l2"= 78.27875,
                          "ratio_corte"= 0.02668185
                        )
