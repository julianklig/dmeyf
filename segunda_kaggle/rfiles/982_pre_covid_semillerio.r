...
# Test de resultados sobre entrenamiento en pandemia
kscript         <- "982_pre_covid_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v090.csv.gz"  #el dataset que voy a utilizar

ktest_mes_hasta  <- 202011  #Esto es lo que uso para testing
ktest_mes_desde  <- 202011

kgen_mes_hasta   <- 202002  #hasta donde voy a entrenar
kgen_mes_desde   <- 201907  #desde donde voy a entrenar
...
#Estos hiperparametros salieron de la optimizacion bayesiana del script 823
# entrenado en meses previos a la pandemia (misma cantidad de meses)
# ganancia  134490124  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 164 de un total de 150 inteligentes
param_ganadores  <- list( "learning_rate"= 0.02000502,
                          "feature_fraction"= 0.5077373,
                          "min_data_in_leaf"= 105,
                          "num_leaves"= 275,
                          "num_iterations"= 452,
                          "ratio_corte"= 0.03317129
                        )
...
set.seed( 524287 )   #dejo fija esta semilla
