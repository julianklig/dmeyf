...
# entrenado en meses de la pandemia
# ganancia  94913375  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 22 de un total de 150 inteligentes
param_ganadores  <- list( "learning_rate"= 0.02000611,
                          "feature_fraction"= 0.1908654,
                          "min_data_in_leaf"= 106,
                          "num_leaves"= 659,
                          "num_iterations"= 717,
                          "ratio_corte"= 0.02883521
                        )
