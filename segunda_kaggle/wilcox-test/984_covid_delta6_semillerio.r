...
kscript         <- "984_covid_delta6_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v094.csv.gz"  #el dataset que voy a utilizar
...
# ganancia 7136250  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 18 de un total de 100 inteligentes
param_ganadores  <- list( "learning_rate"= 0.09294088,
                          "feature_fraction"= 0.2537298,
                          "min_data_in_leaf"= 2084,
                          "num_leaves"= 590,
                          "num_iterations"= 184,
                          "lambda_l1"= 0.5364591,
                          "lambda_l2"= 2.132546,
                          "ratio_corte"= 0.0419397
                        )
