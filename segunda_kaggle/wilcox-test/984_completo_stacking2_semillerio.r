...
kscript         <- "984_completo_stacking2"
karch_dataset   <- "./datasets/dataset_stacking_v110.csv.gz"  #el dataset que voy a utilizar
...
kgen_mes_desde   <- 201910  #desde donde voy a entrenar
...
param_basicos  <- list( objective= "binary",
                        ...
                        max_bin=2000 ,            #por ahora, lo dejo fijo
                        force_row_wise= TRUE    #para que los alumnos no se atemoricen con tantos warning
                       )


#Estos hiperparametros salieron de la optimizacion bayesiana del script 847
# hiperparametros encontrados en la iteracion bayesiana 44 de un total de 200 inteligentes
param_ganadores  <- list( "learning_rate"= 0.02163082,
                          "feature_fraction"= 0.6005608,
                          "min_data_in_leaf"= 617,
                          "num_leaves"= 830,
                          "num_iterations"= 425,
                          "lambda_l1"= 2.065968,
                          "lambda_l2"= 195.376,
                          "ratio_corte"= 0.03025372
                        )
