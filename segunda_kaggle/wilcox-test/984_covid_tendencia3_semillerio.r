...
kscript         <- "984_covid_tendencia3_epic"
karch_dataset   <- "./datasets/dataset_epic_full_v096.csv.gz"  #el dataset que voy a utilizar
...
# entrenado en meses en pandemia
# ganancia 7460000  ( sobre la mitad de 202011 )
# hiperparametros encontrados en la iteracion bayesiana 18 de un total de 100 inteligentes
param_ganadores  <- list( "learning_rate"= 0.05368496,
                          "feature_fraction"= 0.7343407,
                          "min_data_in_leaf"= 2898,
                          "num_leaves"= 899,
                          "num_iterations"= 472,
                          "lambda_l1"= 6.639196,
                          "lambda_l2"= 121.0845,
                          "ratio_corte"= 0.04345443
                        )
